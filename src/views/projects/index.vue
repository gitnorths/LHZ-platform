  ...
  <div class="lhz-layout projects">
            ...
            >
              ...
              <ul>
                <li
                  ...
                  :key="idx"
                  @click="onChangePop(data.active, data.curr)"
                >
    ...
    >
      <div class="lhz-tabs">
        <div class="lhz-tabs__header">
          <div class="lhz-tabs__nav">
            <div
              ...
              :key="i"
              @click="jump(item.active)"
              :class="`lhz-tabs__item ${
                tabActive === item.active ? 'active' : ''
              }`"
            >
              {{ item.name }}
            </div>
        ...
        <div
          class="lhz-tabs__content tabContent"
          ref="tabContent"
          @scroll="handleScroll"
        >
          <template v-if="current === 0">
            ...
            <el-card class="dialog-card conBlock">
              <template #header>
              ...
              <el-form size="mini" label-width="120px">
                ...
                <el-form-item>
                  <span>许子云 市发改委副主任</span>
                </el-form-item>
                <el-form-item>
                  <span>沈美林 市科技局副局长</span>
                </el-form-item>
                <el-form-item>
                  <span>王建良 市财政局副局长</span>
                </el-form-item>
                <el-form-item>
                  <span>王海波 市国土局副局长</span>
                </el-form-item>
                <el-form-item>
                  <span>陆振超 市水利局副局长</span>
                </el-form-item>
                <el-form-item><span>冯瑞兴 市农委副主任</span></el-form-item>
                <el-form-item>
                  <span>周洪海 市环保局副局长</span>
                </el-form-item>
                <el-form-item>
                  <span>钱敏芳 浏河镇人民政府副镇长</span>
                </el-form-item>
                <el-form-item>
                  <span>陆 &nbsp;&nbsp;明 城厢镇党委副书记</span>
                </el-form-item>
                <el-form-item>
                  <span>王建春 沙溪镇人民政府副镇长</span>
                </el-form-item>
                <el-form-item>
                  <span>杨翠珠 璜泾镇人民政府副镇长</span>
                </el-form-item>
                <el-form-item>
                  <span>龚惠琴 浮桥镇人民政府副镇长</span>
                </el-form-item>
                <el-form-item>
                  <span>朱庆兰 双凤镇人民政府副镇长</span>
                </el-form-item>
                <el-form-item>
                  <span>吴振键 科教新城管委会副主任</span>
                </el-form-item>
                <el-form-item>
                  <span>朱建东 娄东街道办事处副主任</span>
                </el-form-item>
              </el-form>
              <p>
            ...
            <el-card class="dialog-card conBlock">
              ...
              <el-form size="mini" label-width="120px">
                <el-form-item label="组 &nbsp;&nbsp;长：">
                  <span>张 义 镇党委副书记、镇长</span>
                </el-form-item>
                <el-form-item label="副组长：">
                  <span>顾益新 镇党委委员、人大主席</span>
                </el-form-item>
                ...
                <el-form-item>
                  <span>仇 &nbsp;&nbsp;刚 东仓村村委会主任</span>
                </el-form-item>
                <el-form-item>
                  <span>陆 &nbsp;&nbsp;建 河桥村村委会主任</span>
                </el-form-item>
                <el-form-item>
                  <span>顾解龙 新闸村村委会主任</span>
                </el-form-item>
                <el-form-item>
                  <span>严利明 万安村村委会主任</span>
                </el-form-item>
                <el-form-item>
                  <span>马宏飞 张桥村村委会主任</span>
                </el-form-item>
                <el-form-item>
                  <span>沈建新 新塘村村委会主任</span>
                </el-form-item>
              </el-form>
              <p>
                工作小组下设办公室，办公室设在镇农技站，由刘传松同志兼任办公室主任。
              </p>
              <el-image
                style="width: 90%; margin: 0 auto; display: block"
                :src="file3"
          ...
          <template v-else-if="current === 1">
            ...
            <el-card class="dialog-card conBlock">
              ...
              <p>
                根据《中华人民共和国建筑法》，在本项目的进行过程中，实施建设监理制度，委托有相应资质的监理单位进行全过程监理，包括施工阶段、竣工验收阶段的监理。委托监理企业建立现场建设监理机构，按规范、监理规划和细则项目监理等指导性文件，实施工程的质量、投资、进度、安全控制。
              </p>
            </el-card>
            ...
            <el-card class="dialog-card conBlock">
              ...
              <p>
                首先制定保证质量的各种措施，对承接项目任务的单位进行资质审查，对涉及质量的材料进行验收和控制，对设备进行预检控制，对有关方案进行审查。其次，对工程质量进行控制，对工序交接、隐蔽工程检查、设计的变更审核、质量事故的处理、质量和技术鉴证等进行控制，对出现违反质量规定的事件、容易形成质量隐患的做法采取措施予以制止。最后建立实施质量日记、质量汇报会等制度以了解和掌握质量动态，及时处理质量问题。
              </p>
            </el-card>
            ...
            <el-card class="dialog-card conBlock">
              ...
              <p>
                首先编制或审核项目实施总进度计划，审核项目阶段性进度计划，制定或审核材料供应采购计划，寻找出进度控制点，确定完成日期。其次建立反映工程进展情况的日记，进行工程进度检查对比，对有关进度及时计量并进行鉴证，召开现场进度协调会等。最后当实施进度的计划发生差异时必须及时制定对策。制定保证不突破总工期的措施，包括组织措施、技术措施、经济措施等。制定总工期突破后的补救措施，然后调整其他计划，建立新的平衡。
              </p>
            </el-card>
            ...
            <el-card class="dialog-card conBlock">
              ...
              <p>
                首先，进行风险预测，采取相应的防范措施。熟悉项目设计图纸与设计要求，分析项目价格构成因素，事前分析费用最容易突破的环节，从而明确投资控制的重点。其次，定期检查和对照费用支付情况，对项目费用超支和节约情况做出分析。提出改进方案，完善信息制度，掌握市场调价范围和幅度。最后，审核信息制度，掌握市场指导价范围和幅度。
              </p>
            </el-card>
            ...
            <el-card class="dialog-card conBlock">
              ...
              <p>
                根据《中华人民共和国建筑法》、《建筑安全生产监督管理规定》、《江苏省建设管理条例》等国家、省、市有关法规，在施工过程中，建筑工程安全生产管理必须坚持安全第一、预防为主的方针，建立健全安全生产的责任制度和群防群治制度。
              </p>
            </el-card>
            ...
            <el-card class="dialog-card conBlock">
              ...
              <p>
                项目的开发过程需要处理与规划、建设、交通、消防、环保、水、电、通讯等有关部门的协调问题。严格遵守国家有关规章制度，积极主动和各级职能部门配合，争取各部门的帮助，以保证建设项目的顺利进行。
              </p>
            </el-card>
            ...
            <el-card class="dialog-card conBlock">
              ...
              <p>
                在接到施工单位的完工报告后，及时组织初验。该项目全部建成后，由项目建设领导小组以及发改、财政、农业、环保等其它部门的专业技术人员和专家组成的验收委员会验收项目，签发竣工验收报告。
              </p>
            </el-card>
          </template>
...
const jump = (i) => {
  ...
  tabActive.value = i;
  block[i].scrollIntoView({ block: "start", behavior: "smooth" });
};
...
const handleScroll = (e) => {
  ...
  blocks.forEach((item, index) => {
    if (tabContent.scrollTop >= item.offsetTop) {
      tabActive.value = index;
    }
  });
  // if(e.scrollTop + e.offsetHeight == e.scrollHeight){ // 触底
  //   form.active = Object.keys(form.steps).length - 1;
  // }
};

const onChangePop = (index, curr) => {
