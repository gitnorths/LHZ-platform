...
const routes = [
  ...
  },
  {
    ...
    // redirect: "@/views/effect/index.vue",
    meta: { title: "实施效果" },
    children: [
      {
        name: "EffectHome",
        path: "/effect",
        component: () => import("@/views/effect/Home.vue"),
        meta: { title: "首页" },
      },
      {
        name: "Farmland",
        path: "/effect/farmland",
        component: () => import("@/views/effect/farmland.vue"),
        meta: { title: "农田面源污染防治" },
      },
      {
        name: "Farming",
        path: "/effect/farming",
        component: () => import("@/views/effect/farming.vue"),
        meta: { title: "养殖污染物治理" },
      },
      {
        name: "Purify",
        path: "/effect/purify",
        component: () => import("@/views/effect/purify.vue"),
        meta: { title: "地表径流污水净化" },
      },
      {
        name: "Setting",
        path: "/effect/setting",
        component: () => import("@/views/effect/setting.vue"),
        meta: { title: "配套工程" },
      },
    ],
  },
